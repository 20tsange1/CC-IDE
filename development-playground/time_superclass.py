...
# def override(method):
#     # This decorator checks if the method is actually overriding a method from the superclass
#     if not hasattr(super(method.__self__, method), method.__name__):
#         raise TypeError(f"{method.__name__} is not overriding a method from the superclass!")
#     return method

# Doesn't work need to fix

# US time vs UK time, not specified in grammar, so how will someone know unless > 12.

# "Deemed time", is it exclusive of times.

# two way function, displaying time in their format.
